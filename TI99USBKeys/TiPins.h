...
int ti_c3 = 3; // key_cable_pin_15  (M J U 7 4 F R V)
int ti_c2 = 4; // key_cable_pin_14  (, K I 8 3 D E C)
int ti_c1 = 5; // key_cable_pin_13  (. L O 9 2 S W X)
int ti_c0 = 6; // key_cable_pin_12  (= space enter fctn shift ctrl)
int ti_r7 = 8; // key_cable_pin_11 (X C V B Z)
int ti_r6 = 7; // key_cable_pin_10 (ctrl W E R T Q)
int ti_c4 = 2; // key_cable_pin_9   (N H Y 6 5 G T B)
int ti_c5 = 22; // key_cable_pin_8   (/ ; P 0 1 A Q Z)
int ti_r4 = 21; // key_cable_pin_7  (fctn 2 3 4 5 1 alpha_lock)
int ti_c6 = 20; // key_cable_pin_6   (alpha_lock)
int ti_r0 = 19; // key_cable_pin_5  (= . , M N /)
int ti_r1 = 18; // key_cable_pin_4  (space L K J H ;)
int ti_r5 = 17; // key_cable_pin_3  (shift S D F G A)
